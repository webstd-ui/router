...
export const favorite: InferRouteHandler<typeof routes.contact.favorite> = async ({
    params,
    formData,
    url,
}) => {
...
export const destroy: InferRouteHandler<typeof routes.contact.destroy> = async ({ params }) => {
    await deleteContact(params.contactId);
    return redirect("/");
};

export const create: InferRouteHandler<typeof routes.contact.create> = async () => {
